...
const Cta = () => {
    ...
    return (
        <div className="font-Aeonik overflow-hidden  " id={"contact"}>
            <div className='relative flex flex-col justify-between items-center group h-[600px]'>
                ...
                <div className='w-[1140px] bg-white absolute -bottom-32 left-1/2 transform -translate-x-1/2 z-10 group-hover:bottom-32 transition-all duration-1000 flex justify-center'>
                    <Image width={1000} height={500} src="/photos/logoBottom.png" className='object-cover ' alt='' />
                </div>
