    ...
    return (
        <div className="relative mt-10 block xl:hidden ">
            ...
            >
                ...
                <p className="text-[32px] md:text-[50px] leading-9 md:leading-normal tracking-tighter ml-4 md:px-2 md:mx-2">See
                                ...
                                <div className="flex gap-4 h-[200px] md:h-[408px]">
                                    <div className="overflow-hidden rounded-xl md:h-fit h-[200px] relative   group">
                                        <Image
                                            ...
                                            width={800}
                                            height={800}
                                            className="w-[400px] h-[200px] md:w-[800px] md:h-[408px] object-cover object-top rounded-xl transform transition duration-300 group-hover:scale-105 origin-center"
                                        />
                                        <div
