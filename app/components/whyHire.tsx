        ...
        <div>
            <div className="relative mt-12 h-[400px] md:h-screen md:flex items-start md:items-center justify-center ">
                ...
                <div
                    ...
                    <BlurText text='see'
                              style='bg-opacity-70 tracking-tight font-bold rounded-full mt-5 absolute top-0 xl:top-20 left-6 md:left-24 xl:left-48'/>
                    <BlurText text='all'
                              style='bg-opacity-70 tracking-tight font-bold rounded-full absolute top-16 md:top-[120px] xl:top-[180px] left-12 md:left-[64px] lg:left-[200px] xl:left-[255px]'/>
                    <BlurText text='the'
                              style='bg-opacity-70 tracking-tight font-bold rounded-full -mt-10 absolute bottom-10 md:-bottom-6 xl:bottom-40 right-14 md:right-60'/>
                    <BlurText text='benefits'
                              style='bg-opacity tracking-tight-70 font-bold rounded-full absolute bottom-0 md:-bottom-24 xl:bottom-20 right-[20px]'/>
                </div>
                    ...
                    <FadeInAnimation>
                        <div>
                            ...
                            <p className="border-t-2 border-black md:mx-4 py-2 text-[10px] md:text-base">
                                Need to tweak your website, swap out a post, or adjust a visual? You got it. We build
                                things so changes are quick, not messy. </p>
                        </div>
                    </FadeInAnimation>
                </div>
                    ...
                    <FadeInAnimation>
                        <div>
                            <div className={"flex gap-2 items-center md:px-4 py-2"}>
                                ...
                                <h2 className={"text-sm md:text-[xl] md:text-3xl tracking-tight"}>Platform Ready
                                </h2>
                            </div>

                            <p className={"border-t-2 border-black md:mx-4 py-2 text-[10px] md:text-base"}>We design and
                                build with each platform’s quirks and limitations in mind, so your posts don’t get cut
                                off and your site passes basic audits.
                            </p></div>
                    </FadeInAnimation>
                    ...
                    <FadeInAnimation>
                        <div>
                            <div className={"flex gap-2 items-center md:px-4 py-2"}>
                                ...
                                <h2 className={"text-sm md:text-[xl] md:text-3xl tracking-tight "}>Full Ownership
                                </h2>
                            </div>

                            <p className={"border-t-2 border-black md:mx-4 py-2 text-[10px] md:text-base"}>No
                                locked-down files, weird dependencies, or unclear licenses. When the project’s done,
                                it’s all yours.
                    ...
                    <FadeInAnimation>
                        ...
                        <div>
                            <div className={"flex gap-2 items-center md:px-4 py-2"}>
                                ...
                                <h2 className={"text-sm md:text-[xl] md:text-3xl tracking-tight"}>Consistent Output

                                </h2>
                            </div>

                            <p className={"border-t-2 border-black md:mx-4 py-2 text-[10px] md:text-base"}>
                                Your presence stays visually and structurally consistent across devices, screens, and
                                content types.
                    ...
                    <div
                        ...
                        <FadeInAnimation>
                            <div className='max-w-[220px]'>
                                ...
                                <p className="border-t-2 border-black md:mx-4 py-2 text-sm ">
                                    Need to tweak your website, swap out a post, or adjust a visual? You got it. We build things so changes are quick, not messy.
                                </p>
                            </div>
                        </FadeInAnimation>
                    </div>
