...
const Hero = () => {
    ...
    return (
        <div className=' md:h-screen  xl:justify-start md:pt-10 xl:pt-0  relative flex flex-col  lg:px-0'>
        ...
        <span className="inline-block w-full h-fit">
            ...
            <video
                ...
                muted
                playsInline
                className='relative xl:absolute bottom-0  xl:right-0 h-[300px] md:h-[65vh] xl:h-fit md:w-screen xl:w-[1000px] z-0 object-cover'
            />
