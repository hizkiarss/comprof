...
const Socmed = () => {
    return (
        <div className='flex justify-between  mt-20 gap-24 relative'>
            <div className='sticky top-14 self-start'>
                <p className='tracking-tighter text-[30px] -mt-8'>
                    social media
                </p>
                <p className="font-Edwardian tracking-tighter font-medium text-[60px] md:text-[60px] -ml-1 mr-3 relative inline-block transition-all duration-400 -mt-10 ">
                    management
